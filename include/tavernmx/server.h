...
namespace tavernmx::server
{
	...
	public:
         ...
         */
		ServerError(std::string what, const std::exception& inner) noexcept : what_str{ std::move(what) } {
	...
	public:
         ...
         */
		explicit ServerConfiguration(std::string_view config_path);
	...
	public:
		...
		/// User name utilizing this connection.
		std::string connected_user_name{};

		/**
         * @brief Creates a ClientConnection representing the given \p client_bio.
         * @param client_bio An active BIO generated by the server's accept BIO. This class
         * takes ownership of it.
         */
		explicit ClientConnection(ssl::ssl_unique_ptr<BIO> client_bio) { this->bio = std::move(client_bio); };
	...
	public:
         ...
         * @param accept_port TCP port to listen for new connections.
         */
		...
		ClientConnectionManager(ClientConnectionManager&& other) noexcept { *this = std::move(other); };
...
namespace tavernmx::rooms
{
	...
	public:
         ...
         */
		explicit ServerRoom(std::string_view room_name) : Room{ room_name } {};
		...
		void clean_expired_clients() {
			std::erase_if(this->joined_clients,
				[](const std::weak_ptr<server::ClientConnection>& connection) { return connection.expired(); });
		};
